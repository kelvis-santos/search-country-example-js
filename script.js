...
async function searchCountry(sugg) {
    // https://countrylayer.com/documentation/ OR https://rapidapi.com/collection/country-data-api
    return await fetch(`https://restcountries.eu/rest/v2/name/${sugg}?access_key=API_KEY`)
}
